...
# CONSTRAINTS
    ...
    # Energy
    e_buy = dual_model.addConstr(-p_flow - max_grid <= data.Prices, name='e_buy')
    ...
    m_CO2_buy = dual_model.addConstr(CO2_str_min - CO2_str_max + CO2_comp <= data.CO2_prices, name='m_CO2_buy')
